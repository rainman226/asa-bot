...
public class OriconService {
    ...
    //the url is diferent in this case, need to review it
    public String getDailySinglesRankings(int year, int month) throws IOException {
        String page = getPage("d", year, month);
        StringBuilder result = new StringBuilder();
        result.append(parsePage(page)).append("\n");

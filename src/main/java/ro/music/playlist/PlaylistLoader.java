...
{
    private final String playlistFolder = "D:\\Projects\\AsaBot\\src\\main\\resources\\playlist-folder";
    ...
    public List<String> getPlaylistNames()
    {
        if(folderExists())
        {
            File folder = new File(OtherUtil.getPath(playlistFolder).toString());
    ...
    public void createFolder()
    {
        try
        {
            Files.createDirectory(OtherUtil.getPath(playlistFolder));
        }
    ...
    {
        return Files.exists(OtherUtil.getPath(playlistFolder));
    }

    public void createPlaylist(String name) throws IOException
    {
        Files.createFile(OtherUtil.getPath(playlistFolder+File.separator+name+".txt"));
    }

    public void deletePlaylist(String name) throws IOException
    {
        Files.delete(OtherUtil.getPath(playlistFolder+File.separator+name+".txt"));
    }

    public void writePlaylist(String name, String text) throws IOException
    {
        Files.write(OtherUtil.getPath(playlistFolder+File.separator+name+".txt"), text.trim().getBytes());
    }
    ...
    public Playlist getPlaylist(String name)
    {
        ...
        try
        {
            if(folderExists())
            {
                ...
                Files.readAllLines(OtherUtil.getPath(playlistFolder+File.separator+name+".txt")).forEach(str ->
                {
                    String s = str.trim();
                    if(s.isEmpty())
                        return;
